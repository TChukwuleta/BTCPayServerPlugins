...
var included = new HashSet<string> { "BTCPayServer.Plugins.BigCommercePlugin", "BTCPayServer.Plugins.ServerAlert", "BTCPayServer.Plugins.LightSpeed", "BTCPayServer.Plugins.StoreBridge", "BTCPayServer.Plugins.SatoshiTickets" };
