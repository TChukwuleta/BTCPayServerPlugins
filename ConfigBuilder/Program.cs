...
var included = new HashSet<string> { "BTCPayServer.Plugins.SatoshiTickets", "BTCPayServer.Plugins.JumpSeller", "BTCPayServer.Plugins.LightSpeed", "BTCPayServer.Plugins.NairaCheckout" };
