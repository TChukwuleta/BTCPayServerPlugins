...
public class StoreBridgeDbContextFactory : BaseDbContextFactory<StoreBridgeDbContext>
{
    public StoreBridgeDbContextFactory(IOptions<DatabaseOptions> options) : base(options, "BTCPayServer.Plugins.StoreBridge")
    {
    }
