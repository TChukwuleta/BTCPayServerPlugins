...
public class JumpSellerPlugin : BaseBTCPayServerPlugin
{
    ...
    public override void Execute(IServiceCollection services)
    {
        ...
        services.AddSingleton<SquareUpDbContextFactory>();
        services.AddDbContext<SquareUpDbContext>((provider, o) =>
        {
            var factory = provider.GetRequiredService<SquareUpDbContextFactory>();
